...
from mtlauncher import Mtlauncher, LauncherImportance
...
def test_reading_single_launcher_file_works(context, single_launcher_file):
    launcher = Mtlauncher(context, launcher_dirs=single_launcher_file)
...
def test_updating_launcher_importance_works(context, single_launcher_file, config_dir):
    launcher = Mtlauncher(context, launcher_dirs=single_launcher_file, config_dir=config_dir)
